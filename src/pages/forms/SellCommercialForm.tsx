...
interface SellCommercialFormProps {
    onSuccess?: () => void;
}

const SellCommercialForm = ({ onSuccess }: SellCommercialFormProps) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        addSubmission({
            ...
            bedrooms: 0,
            bathrooms: parseInt(formData.type === "Office" ? "2" : "1") || 1,
        ...
        return (
            <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                    Thank you for submitting your commercial property. Our team will review it and get back to you within 24-48 hours.
                </p>
    ...
    const commercialAmenities = [
        ...
        "Loading Bay", "CCTV", "Reception Area", "Pantry", "Server Room"
    ];
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2">
                        ...
                        <Input
                            id="title"
                            placeholder="e.g., Premium Office Space in IT Park"
                    ...
                    <div>
                        <Label htmlFor="ageOfProperty">Age of Building</Label>
...
export default SellCommercialForm;

        ...
        <div className="space-y-6">
            ...
            <div>
                <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                    <InboxIcon className="w-8 h-8 text-amber-500" />
                    Pending Sell Requests
                </h1>
                <p className="text-gray-500 mt-1">Review and approve property sell submissions from users</p>
            </div>
                ...
                <CardContent>
                    {pendingSubmissions.length > 0 ? (
                        ...
                        <div className="text-center py-12 text-gray-500">
                            ...
                            <p className="text-lg font-medium">No pending sell requests</p>
            ...
            <Dialog open={!!viewingSubmission} onOpenChange={() => setViewingSubmission(null)}>
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Review the property details and approve or reject this submission.
                        </DialogDescription>
                    </DialogHeader>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        ...
                                        <p><span className="text-gray-500">Construction:</span> {viewingSubmission.constructionStatus || 'N/A'}</p>
...
export default PendingSellRequests;

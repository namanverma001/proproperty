...
const PendingRentRequirements = () => {
    ...
    const formatRent = (min?: number, max?: number) => {
        ...
        if (min) return `Min ₹${(min / 1000).toFixed(0)}K/month`;
        if (max) return `Max ₹${(max / 1000).toFixed(0)}K/month`;
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Review and manage property rental requirements from tenants</p>
                </div>
                <Link to={`${ADMIN_ROUTE}/history?tab=requirements&type=rent`}>
                ...
                <Card>
                    <CardContent className="py-12 text-center">
                        ...
                        <p className="text-muted-foreground">
                            New rental requirements will appear here when users submit them.
                        </p>
                    </CardContent>
                </Card>
            ) : (
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">{formatRent(req.budgetMin, req.budgetMax)}</p>
                                    </div>
                                    {req.propertyCategory === "residential" && (
                                        <div>
                                            <span className="text-muted-foreground flex items-center gap-1">
                                    ...
                                    {req.constructionStatus && (
                                        <div>
                                            <span className="text-muted-foreground">Furnishing Pref</span>
                ...
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        <p className="text-sm text-muted-foreground">
                            {actionType === "contact"
                                ? "Add notes about your contact with this renter."
...
export default PendingRentRequirements;
